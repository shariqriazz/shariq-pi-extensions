...
- Uses SQLite as the source of truth. The two generated `MEMORY.md` surfaces are read-only projections for people:
  ...
  - `<agent-dir>/pi-memory/projects/<project-slug>-<project-hash-prefix>/MEMORY.md`
...
- `src/retrieval.ts` — scoped retrieval and character-bounded estimated context injection.
